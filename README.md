...
Você pode aprender mais na [documentação Criar aplicativo React](https://pt-br.reactjs.org/docs/create-a-new-react-app.html).

Para aprender o React, confira a [documentação do React](https://pt-br.reactjs.org/).


<h1 align="center">Documentation in english</h1>
